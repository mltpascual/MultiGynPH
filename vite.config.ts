...
// Conditionally load Manus-specific plugins only in development
...
if (!isProduction) {
  try {
    ...
    // Plugin not available outside Manus environment — skip silently
  }
    ...
    rollupOptions: {
      output: {
        manualChunks: {
          ...
          ui: ["@radix-ui/react-accordion", "@radix-ui/react-tabs", "@radix-ui/react-tooltip", "@radix-ui/react-dialog"],
        },
      },
    },
  },
